...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color :powderblue;">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="img/sparksbank.jpg" class="img-fluid pt-2">
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="img/username.png" class="img-fluid">
                    <br>
                    <a href="createuser.php"><button style="background-color : #2785C4;">Create a User</button></a>
                  </div> 
                  <div class="col-md act">
                    <img src="img/transcations.png" class="img-fluid">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>SRUJAMI PALKAR</b> <br> THE SPARKS FOUNDATION PROJECT</p>
      </footer>
